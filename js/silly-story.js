...
function result() {
    ...
    // Used replaceAll, replace function for this part
    ...
    if (document.getElementById("metric").checked) {
        ...
        var weight = Math.round(0.453592 * 300);
        ...
        newStory = newStory.replace('94', Math.round(temp));
        newStory = newStory.replace('farenheit', '°C');
    }
